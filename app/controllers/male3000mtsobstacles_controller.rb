class Male3000mtsobstaclesController < ApplicationController
  ...
  # GET /male3000mtsobstacles.json
    def index
     ...
     format.html
      format.json { render json: Male3000mtsobstaclesDatatable.new(view_context) }
      format.xlsx
    end
end

def import
Male3000mtsobstacle.import(params[:file])
redirect_to male3000mtsobstacles_url, notice: "Importado correctamente"
end
  ...
  def create
    ...
    respond_to do |format|
      if @male3000mtsobstacle.save
        format.html { redirect_to action:index, notice: 'Male3000mtsobstacle was successfully created.' }
