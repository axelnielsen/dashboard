...
class StagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post stages_url, params: { stage: { championship_id: @stage.championship_id, fecha: @stage.fecha, name: @stage.name } }
    end
  ...
  test "should update stage" do
    patch stage_url(@stage), params: { stage: { championship_id: @stage.championship_id, fecha: @stage.fecha, name: @stage.name } }
