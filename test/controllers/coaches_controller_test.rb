...
class CoachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post coaches_url, params: { coach: { birthdate: @coach.birthdate, cellPhone: @coach.cellPhone, mail: @coach.mail, names: @coach.names, rut: @coach.rut, sex: @coach.sex, surnames: @coach.surnames } }
    end
  ...
  test "should update coach" do
    patch coach_url(@coach), params: { coach: { birthdate: @coach.birthdate, cellPhone: @coach.cellPhone, mail: @coach.mail, names: @coach.names, rut: @coach.rut, sex: @coach.sex, surnames: @coach.surnames } }
