...
class ChampionshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create championship" do
    assert_difference('Championship.count') do
      post championships_url, params: { championship: { address: @championship.address, findate: @championship.findate, idRegion: @championship.idRegion, initdate: @championship.initdate, name: @championship.name } }
    end
  ...
  test "should update championship" do
    patch championship_url(@championship), params: { championship: { address: @championship.address, findate: @championship.findate, idRegion: @championship.idRegion, initdate: @championship.initdate, name: @championship.name } }
