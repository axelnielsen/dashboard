...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post competitions_url, params: { competition: { category_id: @competition.category_id, hour: @competition.hour, sex_id: @competition.sex_id, sport_id: @competition.sport_id, stage_id: @competition.stage_id } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { category_id: @competition.category_id, hour: @competition.hour, sex_id: @competition.sex_id, sport_id: @competition.sport_id, stage_id: @competition.stage_id } }
